...
public class AppConstants {
	...
	public static final String INVALID_LOGIN_CRED_MESG = "Warning: No match for E-Mail Address and/or Password.";
	public static final String INVALID_BLANK_CRED_MESG = "Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.";
