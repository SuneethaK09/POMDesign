...
public class SearchResultsPage {
	...
	public SearchResultsPage(WebDriver driver) {
		...
		public int getSearchResultsCount() {
			int resultCount = eleUtil.waitForElementsPresence(resultsHeader, AppConstants.DEFAULT_MEDIUM_WAIT).size();
		...
		public String getResultHeaderValue() {
			...
			System.out.println("Search results header: " + header);
			return header;
		}
		
		public ProductInfoPage selectProduct(String productName) {
			System.out.println("Select product with name: "+ productName );
