...
public class ElementUtil {
	...
	public void doSendKeys(By locator, String value) {
		log.info("Entering the value: "+ value + "using the locator" + locator);
		if (value == null) {
	...
	public WebElement getElement(By locator) {
		...
		log.info("Element is found using the locator: " + locator);
	 ...
	 * @return
	 */
	@Step("Waiting for element: {0} is visible with the timeout: {1}")
	public WebElement waitForElementVisible(By locator, int timeout) {
		log.info("Waiting for element using locator: " + locator + " within the timeout: " + timeout );
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
